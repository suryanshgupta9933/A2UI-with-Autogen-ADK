...
let ChatApp = class ChatApp extends SignalWatcher(LitElement) {
    constructor() {
        super(...arguments);
        ...
        this.lightProcessor = v0_8.Data.createSignalA2uiMessageProcessor();
    }
    ...
    render() {
      ...
      <div class="chat-panel">
        ...
        <div class="chat-history">
          ${repeat(this.messages, (m) => m.id, (m) => html `<chat-message .role=${m.role} .text=${m.text}></chat-message>`)}
...
__decorate([
    ...
    state()
], ChatApp.prototype, "theme", void 0);
__decorate([
    state()
...
export { ChatApp };
let ArtifactRenderer = class ArtifactRenderer extends SignalWatcher(LitElement) {
    constructor() {
        super(...arguments);
...
__decorate([
    provide({ context: UI.Context.themeContext }),
    state()
], ArtifactRenderer.prototype, "theme", void 0);
__decorate([
    state()
], ArtifactRenderer.prototype, "processor", void 0);
ArtifactRenderer = __decorate([
